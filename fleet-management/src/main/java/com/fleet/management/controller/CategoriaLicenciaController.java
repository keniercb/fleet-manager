...
public class CategoriaLicenciaController {
    ...
    @GetMapping
    public ResponseEntity<Page<CategoriaLicenciaResponse>> findAll(@RequestParam(defaultValue = "0") Integer page, @RequestParam(defaultValue = "20") Integer perPage, @RequestParam(defaultValue = "id") String sort, @RequestParam(defaultValue = "ASC") String sortOrder) {
